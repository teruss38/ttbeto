...
body{
  ...
  --mfn-section-tabber-nav-active-color:<?php echo esc_attr($color_theme); ?>;
  ...
  --mfn-blocks-checkout-summary-bg: <?php echo mfn_opts_get('gutenberg-checkout-summary-background', 'rgba(0,0,0,0.03)'); ?>
}
...
.content_slider.flat.description ul li .desc, .content_slider.flat.description ul li a .desc, .post-nav.minimal a i, .mfn-marquee-text .mfn-marquee-item-label {
...
.widget_recent_comments ul li:after, .widget_nav_menu ul, .woocommerce ul.products li.product .price, .shop_slider .shop_slider_ul .item_wrapper .price,
...
.woocommerce .shop_table .product-name .variation > dd, .shipping-calculator-button:after,  .shop_slider .shop_slider_ul .item_wrapper .price del,
...
.mfn-countdown{
	--mfn-countdown-number-color: <?php echo esc_attr(mfn_opts_get('color-quickfact-number', '#0089F7')) ?>;
}
...
.mfn-floating-placeholder .mfn-input-wrapper.mfn-not-empty:before{ background-color:<?php echo esc_attr(mfn_hex2rgba(mfn_opts_get('background-form', '#ffffff'), $formAlpha)) ?>; }
...
.mfn-desc-expandable .read-more{ background: linear-gradient(180deg, <?php echo esc_attr(mfn_opts_get('color-shop-cat-desc-gradient','rgba(255,255,255,0)',[ 'key' => 'from' ])); ?> 0%, <?php echo esc_attr(mfn_opts_get('color-shop-cat-desc-gradient','rgba(255,255,255,1)',[ 'key' => 'to' ])) ?> 65%); }
...
<?php
  ...
  if ( $sidecart_product_quantity_color = mfn_opts_get( 'sidecart-product-quantity-color' ) ){
    echo '.mfn-cart-holder .mfn-ch-content .mfn-ch-product input{color:'. esc_attr($sidecart_product_quantity_color) .'}';
  }
  if ( $sidecart_product_quantity_button_background = mfn_opts_get( 'sidecart-product-quantity-button-background' ) ){
    echo '.mfn-cart-holder .quantity a.quantity-change,.mfn-cart-holder .quantity a.quantity-change:hover{background-color:'. esc_attr($sidecart_product_quantity_button_background) .'}';
  }
  if ( $sidecart_product_quantity_button_color = mfn_opts_get( 'sidecart-product-quantity-button-color' ) ){
    echo '.mfn-cart-holder .quantity a.quantity-change{color:'. esc_attr($sidecart_product_quantity_button_color) .'}';
  }
